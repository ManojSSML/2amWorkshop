...
export default function AgentsSection() {
  ...
  return (
    <section ref={ref} data-section="agents" id="agents" style={{
      background: '#EDECEA',
      width: '100%',
      minHeight: '100vh',
      display: 'flex',
      ...
      <style>{`
        @media (max-width: 1024px) {
          .agents-inner { gap: 40px !important; }
          .agents-inner > div:last-child { width: 400px !important; height: 307px !important; }
        }
        @media (max-width: 768px) {
          .agents-inner { padding: 80px 24px !important; flex-direction: column !important; gap: 40px !important; }
          .agents-inner > div:last-child { width: 100% !important; height: 260px !important; }
        }
      `}</style>
    </section>
  );
