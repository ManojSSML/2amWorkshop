    ...
    >
      <div
        style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: `url('/eyewear.svg')`,
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(to right, rgba(0,0,0,0.1) 0%, rgba(0,0,0,0.55) 50%, rgba(0,0,0,0.62) 100%)',
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Not every turning point arrive
              <br />
              with certainty.
            </h2>
